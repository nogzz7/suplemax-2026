...
// ========== FUNÇÃO ENVIAR PEDIDO PARA O WHATSAPP DA LOJA ==========
function sendWhatsAppMessage(name, phone, items, total, orderId, discount, coupon, address, payment) {
  // Número fixo da loja SUPLEMAX em Cuzinha - MG
  const lojaPhone = '55339998253024'; // (33) 99982-53024
  ...
  msg += `🔗 *Clique aqui para falar diretamente com o cliente* (copie o número e cole no WhatsApp)`;

  // Abre o WhatsApp da loja com a mensagem do pedido
